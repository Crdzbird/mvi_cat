...
import ni.devotion.catfactsapp.retrofit.BreedsNetworkEntity
import ni.devotion.catfactsapp.retrofit.CatNetworkEntity
import ni.devotion.catfactsapp.utils.EntityMapper
import javax.inject.Inject

class BreedsCacheMapper
@Inject
constructor():
    EntityMapper<BreedsCacheEntity, Breeds> {
    override fun mapFromEntity(entity: BreedsCacheEntity): Breeds {
        return Breeds(
    ...
    override fun mapToEntity(domainModel: Breeds): BreedsCacheEntity {
        return BreedsCacheEntity(
    ...
    fun mapFromEntityList(entities: List<BreedsCacheEntity>): List<Breeds>{
